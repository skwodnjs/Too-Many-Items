...
public class PlayerStatsProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    private final LazyOptional<PlayerStats> optional = LazyOptional.of(this::createStatsBtConsumables);

    private PlayerStats createStatsBtConsumables() {
    ...
    public CompoundTag serializeNBT() {
        ...
        createStatsBtConsumables().saveNBTData(nbt);
        return nbt;
    }

    @Override
    public void deserializeNBT(CompoundTag nbt) {
        createStatsBtConsumables().loadNBTData(nbt);
    }
}