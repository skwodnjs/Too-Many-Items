...
public class SynthesisCommonScreen extends AbstractContainerScreen<SynthesisCommonScreenMenu> {
    ...
    public SynthesisCommonScreen(SynthesisCommonScreenMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
