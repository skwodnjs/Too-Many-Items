...
public class RouletteCommonScreen extends AbstractContainerScreen<RouletteCommonScreenMenu> {
    private static final ResourceLocation resourceLocation = new ResourceLocation(Main.MOD_ID, "textures/gui/roulette_screen.png");

    public RouletteCommonScreen(RouletteCommonScreenMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
