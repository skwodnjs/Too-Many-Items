...
public class RouletteCommonScreenMenu extends AbstractContainerMenu {
    public final RouletteCommonBlockEntity blockEntity;
    private final Level level;

    public RouletteCommonScreenMenu(int pContainerId, Inventory inventory, FriendlyByteBuf buf) {
...
//            else System.out.println("이걸로는 안되겠는데?");
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.ROULETTE_COMMON.get());
    }
