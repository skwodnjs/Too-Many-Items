...
//            ModItem mainItem = ModItems.ModItemProvider.___getItemByID(mainActiveSlot.itemID);
//            ModItem subItem = ModItems.ModItemProvider.___getItemByID(subActiveSlot.itemID);
